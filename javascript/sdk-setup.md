...
همینطور از این قابلیت می‌توانید برای **ترکر نصب** استفاده کنید و با آن **نصب** کاربرهای مهمان را هم شمارش کنید. به این ترتیب که شما این متد را در صفحه اول قرار می‌دهید تا با هر بازدید جدید یک مهمان ثبت شود.
