...
<h4> 
۱-۲: نصب کتابخانه چابک از طریق <bold>آسنکرون</bold>  
</h4>

برای دریافت کتابخانه از طریق **async** باید از  قطعه کد زیر، چابک را به پروژه خود اضافه کنید. 
...
```
بعد از فراخوانی، متد زیر به راحتی پیاده‌سازی خواهد شد.
...
>`نکته`؛ روش آسنکرون در نصب کتابخانه چابک از فایل **server side rendering** پشتیبانی می‌کند.
...
<h4> 
۲-۱: مقداردهی اولیه در روش <bold>سنکرون</bold>  
</h4>
