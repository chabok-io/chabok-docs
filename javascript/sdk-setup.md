...
> `نکته:` مستندات پیاده‌سازی زیر براساس **نسخه‌های ۲ به بالا** کتابخانه چابک نوشته شده است. در صورتی که از نسخه‌ پایین‌تری استفاده می‌کنید به [این صفحه](/javascript/sdk-setup-old.html) مراجعه کنید.
>
> اگر از نسخه‌های پایین‌تر از ۲ کتابخانه چابک استفاده می‌کنید توصیه می‌کنیم کتابخانه چابک را به نسخه ۲ **ارتقا** دهید.
>
...
[۴- تست پیاده‌سازی](/javascript/sdk-setup.html#۴--تست-پیادهسازی)
...
و یا با استفاده از [CDN](https://unpkg.com/chabokpush@2.0.1/dist/chabokpush.min.js)، چابک را به پروژه خود اضافه کنید.
...
![عکس مربوطه](http://uupload.ir/files/i7fq_web-access-token.png)
