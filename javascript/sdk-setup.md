...
### ۱- نصب کتابخانه
 ...
 #### نصب کتابخانه چابک از طریق **سنکرون** :۱-۱
...
#### نصب کتابخانه چابک از طریق **آسنکرون** :۲-۱
...
>`نکته`: در صورتی که فایل **server side rendering** را دارید از راه‌اندازی آسنکرون در  استفاده کنید. 
...
#### مقدار دهی اولیه در روش **سنکرون** :۱-۲
...
#### مقداردهی اولیه در روش **آسنکرون** :۲-۲
...
- در نسخه‌های قبلی اگر یک فایل اسکریپت در حال بارگذاری بود کلیه فایل‌ها دانلودشان متوقف می‌شدند تا فایل اسکریپت به طور کامل دانلود شود اما در این روش، چند فایل اسکریپت همزمان دانلود و بارگیری می‌شوند.
