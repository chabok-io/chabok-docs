...
در صورتی که اپلیکیشن شما قابلیت **ایجاد حساب کاربری** داشته باشد می‌توانید کاربر را تا زمانی که حساب ایجاد نکرده است با یک **UUID** به عنوان **کاربر مهمان** در سیستم خود ثبت کنید و سپس به محض ایجاد حساب و دریافت اطلاعات او، آن کاربر را به عنوان **کاربر دائم** خود مانند بالا ثبت کنید. 

همینطور از این قابلیت می‌توانید برای **ترکر نصب** استفاده کنید و با آن **نصب** کاربرهای مهمان را هم شمارش کنید. به این ترتیب که شما این متد را در صفحه اول وبسایت خود قرار می‌دهید تا با هر بازدید جدید یک مهمان ثبت شود.
