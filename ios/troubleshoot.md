...
- ##### سوئیچ سرور عملیاتی اپل را در پنل به درستی تنظیم کنید

در پنل سندباکس، سوئیچ سرور عملیاتی اپل باید خاموش باشد تا بتوانید در حالت دیباگ پوش دریافت کنید. اما در پنل عملیاتی، با گذاشتن کلیدهای عملیاتی اپل (فقط در PEM این کلیدها متفاوت هستند)، این سوئیچ را روشن نمایید تا بتوانید در حالت انتشار از اپ استور یا دانلود از لینک، پوش‌ دریافت کنید.
