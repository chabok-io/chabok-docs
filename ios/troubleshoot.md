...
در پنل سندباکس، سوئیچ سرور عملیاتی باید خاموش باشد تا بتوانید در حالت دیباگ پوش دریافت کنید. اما در پنل عملیاتی، با گذاشتن کلیدهای عملیاتی اپل (فقط در PEM این کلیدها متفاوت هستند)، این سوئیچ را روشن نمایید تا بتوانید در حالت ریلیز از اپ استور یا دانلود از لینک پوش دریافت کنید.
