...
با فعال کردن قابلیت `enableLocationOnLaunch`، کتابخانه چابک به هنگام باز شدن برنامه و در صورت پیدا کردن موقعیت مکانی کاربر را به کمک [انتشار رویداد](http://doc.chabokpush.com/ios/delegation.html) به سرور ارسال می کند.
