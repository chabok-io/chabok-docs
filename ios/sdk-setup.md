...
> `نکته:` مستندات پیاده‌سازی زیر **براساس نسخه‌های ۲ به بالا کتابخانه چابک** نوشته شده است، در صورتی که نسخه‌ پایین‌تری دارید [به این صفحه](/ios/sdk-setup-old-version.html) مراجعه کنید.
