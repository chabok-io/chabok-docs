...
پلتفرم چابک در حوزه‌های [اتریبیوشن](/ios/introducing.html#سرویس-اتریبیوشن-attribution)، [زیرساخت آنی](/ios/introducing.html#سرویس-بکند-آنی-realtime-backend-service)، [تعاملات درون‌برنامه‌ای](/ios/introducing.html#ارتباط-مستقل-از-کانال-omni-channel-communication)، [اتوماسیون بازاریابی موبایل](/ios/introducing.html#اتوماسیون-بازاریابی-موبایل-mobile-marketing-automation) و [آنالیتیکس](/ios/introducing.html#آنالیتیکس-موبایل-و-وب-mobile--web-analytics) می‌تواند برای شما مفید باشد.
