...
- #### عدم پیاده‌سازی مراحل ۱ و ۲ بالا
...
- #### یکسان نبودن `senderId` در پنل و متد `init` 
...
- #### در حالت بسته بودن اپ نوتیفیکیشن دریافت می‌شود اما پیام چابک مخصوص باز بودن اپ است
