...
در این صفحه به عیب‌یابی مشکلات متداول توسعه‌دهندگان در پیاده‌سازی چابک و ارائه راه‌‌حل‌های مربوط به آن می‌پردازیم. برخی از این مشکلات عبارتند [دریافت نکردن پوش‌نوتیفیکیشن](https://doc.chabokpush.com/android/troubleshoot.html#۱--پوش-نمیگیرم) و [نمایش ندادن اعلان روی دستگاه کاربر](https://doc.chabokpush.com/android/troubleshoot.html#۲--اعلانها-نمایش-داده-نمیشوند).
...
در صورتی که در [متد `buildNotification` مقدار `false` را قرار دهید](https://doc.chabokpush.com/android/notification-handling.html#%D8%AA%D9%86%D8%B8%DB%8C%D9%85-%D9%86%D9%85%D8%A7%DB%8C%D8%B4-%D8%A7%D8%B9%D9%84%D8%A7%D9%86)، اعلان نمایش داده نمی‌شود. (نمایش اعلان بر عهده خودتان می‌شود)
