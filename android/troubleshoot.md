...
خطای  SENDER_ID_MISMATCH زمانی نمایش داده می‌شود که این دو فایل با هم تطابق نداشته باشند،. به معنای بهتر، این خطا درست زمانی اتفاق می‌افتد که فایل اشتباهی را از پنل فایربیس دانلود کردید و در کنار پروژه ماژول خود قرار دادید و یا اطلاعات اشتباه از پنل فایربیس را در پنل چابک قرار دادید.
