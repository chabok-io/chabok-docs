...
۶- همیشه اطمینان حاصل کنید که فایل **google-services.json** را که از <a href="https://console.firebase.google.com/"> پنل فایربیس </a> دانلود کردید را در پوشه ماژول اصلی پروژه قرار دهید.
