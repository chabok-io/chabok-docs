...
درصورتی که در برنامه خود نیاز به استفاده از موقعیت مکانی کاربر دارید لازم است در ابتدا کتابخانه `chabok-lib:VERSION` را **حذف** و کتابخانه `chabok-lib-geo:VERSION` را **جایگزین کنید**. 
