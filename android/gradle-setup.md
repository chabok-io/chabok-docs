...
درصورتی که در برنامه خود نیاز به استفاده از موقعیت مکانی کاربر دارید لازم است کتابخانه `chabok-lib` را **حذف** و کتابخانه `chabok-lib-geo:VERSION` را **جایگزین کنید**. 
