...
و در صورتی که از **نسخه‌های ۳ به بالاتر کتابخانه چابک** استفاده می‌کنید،  می‌توانید از متد ساده‌تر `trackRevenue` استفاده کنید. این متد در واقع متد بالا (`trackPurchase`) هم را در درون خود دارد.
