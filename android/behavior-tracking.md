...
این کار باید با متد `trackPurchase` برای **نسخه‌های ۳ به بالا کتابخانه چابک** انجام دهید. به عنوان مثال کاربری خریدی با ارزش ۵۰ هزار تومان را انجام داده است.
...
و در صورتی که از **نسخه‌های ۳ به بالاتر کتابخانه چابک** استفاده می‌کنید، `` می‌توانید به آسانی خریدی خریدی با ارزش ۵۰ هزار تومان را انجام داده است. 
