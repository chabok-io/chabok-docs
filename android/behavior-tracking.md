...
[رویدادهایی]() که در اپ شما از سوی کاربر رخ می‌دهند، قابل ذخیره شدن هستند. بنابراین شما می‌توانید برای **درک الگوی استفاده از اپلیکیشنتان** و شناخت کاربرانتان، [رفتار آن‌ها را به طور لحظه‌ای رصد کنید]() و علاوه بر گرفتن بازخورد، براساس این رفتارها آن‌ها را [دسته‌بندی کنید و پیام بفرستید](). همچنین [تاریخچه رفتار کاربران]() به صورت رویدادهای ذخیره شده را می‌توانید مشاهده کنید.
