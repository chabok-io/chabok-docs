...
[رویدادهایی](https://doc.chabokpush.com/android/behavior-tracking.html#مفهوم-رویداد) که در اپ شما از سوی کاربر رخ می‌دهند، قابل ذخیره شدن هستند. بنابراین شما می‌توانید برای **درک الگوی استفاده از اپلیکیشنتان** و شناخت کاربرانتان، [رفتار آن‌ها را به طور لحظه‌ای رصد کنید](https://doc.chabokpush.com/android/behavior-tracking.html#متد-رصد) و علاوه بر گرفتن بازخورد، براساس این رفتارها آن‌ها را [دسته‌بندی کنید و پیام بفرستید](https://doc.chabokpush.com/android/behavior-tracking.html#ارسال-پیام-براساس-رویداد). همچنین [تاریخچه رفتار کاربران](https://doc.chabokpush.com/android/behavior-tracking.html#مشاهده-تاریخچه-رویدادها-از-پنل) به صورت رویدادهای ذخیره شده را می‌توانید مشاهده کنید.
