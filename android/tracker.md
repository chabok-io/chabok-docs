...
با توجه به اینکه این متد در ابتدای هر بازدید فراخوانی می‌شود، برای شمارش نصب با **بازدید اول کاربر** (مانند سرویس ادجاست) می‌توانید از آن استفاده کنید. 
...
به طور کلی چابک دارای دو نوع حساب رایگان (محیط آزمایشی) و عملیاتی  است. در صورتی که روی حساب رایگان هستید می‌توانید روی همان حساب نسخه جدید را منتشر کنید. در صورتی هم که حساب عملیاتی دارید باید حتما **روی محیط عملیاتی** نسخه جدید اپلیکیشن خود را در استورها منتشر کنید.
...
با افزودن SDK چابک و راه‌اندازی آن دراپلیکیشنتان می‌توانید برای کمپین‌های نصب خود ترکر فعال کنید. 
