...
>`نکته`: **lable** مقداری هست که در انتهای لینک ترکر نصب گذاشته می‌شود و با کلیک کاربر بر روی لینک، کاربر به صفحه نصب اپلیکیشن هدایت می‌شود. این مقدار از طریق فراخوانی متد گفته شده قابل دریافت است.
>`نکته`: برای پیاده‌سازی قابلیت دعوت دوستان کایفست در انتهای لینک ترکر نصب به جای user_1001، در انتهای لینک ترکر نصب، آیدی کاربران را قرار دهید. **  
