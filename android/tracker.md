...
#### نکات ضروری نصب کتابخانه   
 ...
 برای دانلود این فایل، مراحل زیر را طی کنید:
  ...
  ۱. به <a href="https://console.firebase.google.com/">پنل فایربیس</a>  وارد شوید و پروژه خود را باز کنید.
...
یکی از راههای موثر برای جذب کاربران به اپلیکیشن، ارسال لینک دعوت به آن‌هاست. برای انجام این کار کافیست به دو روش زیر لینک دعوت را به کاربران ارسال کنید: 

۱.به کاربرانی که عضو اپلیکیشن هستند، لینک دعوت ارسال کنید تا آنها، لینک را با دوستان خود به اشتراک بگذارند و با کلیک کاربران جدید بر روی لینک، به طور خودکار به صفحه نصب اپلیکیشن هدایت شوند و کاربران قدیمی نیز کد تخفیف را دریافت کنند.

۲. فرض کنید کاربری وارد اپلیکیشن شده و در رویدادی ثبتنام کرده است. برای جذب کاربر بیشتر نیاز است در این لحظه لینک دعوتی به او ارسال کنید تا او لینک را با دوستان خود به اشتراک بگذارد و پس از آن کد تخفیفی برای شرکت در رویدادهای بعدی دریافت کند.

<h4>ایجاد لینک دعوت دوستان</h4>

برای ایجاد لینک دعوت دوستان از طریق خود اپلیکیشن کافیست در انتهای لینک ترکر پارامتر `USER_ID` را اضافه کنید.

برای اینکه متوجه شوید نصب اپلیکیشن انجام شده و یا <a href="https://doc.chabok.io/android/release-note.html#%D9%86%D8%B3%D8%AE%D9%87-%DB%B3%DB%B1%DB%B0---%DB%B1%DB%B3%DB%B9%DB%B8%DB%B0%DB%B9%DB%B4"> دعوت‌نامه</a>  به کاربر دیگر ارسال شده، نیاز به فراخوانی متد `setDeferredDataListener`  و پیاده‌سازی متد `onReferralReceived` به کمک کد زیر دارید.
...
اگر قصد دارید لینک دعوت به دوستان را در حساب آزمایشی به کاربران ارسال کنید کافیست لینک ترکر خود را به صورت زیر بنویسید.
