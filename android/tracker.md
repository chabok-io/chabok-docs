...
شما می‌توانید **کلید واژه‌هایی** که کاربر در **گوگل** جستجو کرده است تا اپلیکیشن شما را نصب کند، داشته باشید. چابک این کلید واژه را در سطح `campaign` ایجاد می‌کند. 

علاوه بر آن، پارامتر `utm_medium` را چابک در سطح `adgroup` قرار می‌دهد.
