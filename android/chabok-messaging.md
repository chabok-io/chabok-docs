...
چابک برای پیام‌رسانی با کاربر دو راه را در اختیار شما می‌گذارد. این دو راه [پیام چابک]() و [پوش‌نوتیفیکیشن]() می‌باشند. در این صفحه به اولین راه یعنی نحوه ارسال و دریافت پیام چابک می‌پردازیم. به طور کلی پیام‌رسانی چابک روی [کانال]() انجام می‌شود. به این ترتیب که کاربران برای دریافت پیام‌ها باید در کانال مورد نظر عضو باشند.
