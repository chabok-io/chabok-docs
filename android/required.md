...
در ابتدا اطمینان یابید که صفحه [معرفی](https://doc.chabokpush.com/android/introducing.html) را برای آشنایی کامل با امکانات چابک با دقت مطالعه کرده باشید. شما برای به کار بردن چابک نیاز به [ایجاد حساب کاربری](https://chabokpush.com/register.html) و [ دریافت کلیدهای گوگل](https://doc.chabokpush.com/android/required.html#دریافت-کلیدهای-گوگل) دارید.

<Br>

### ایجاد حساب چابک

به طور کلی حساب‌های چابک به دو بخش **آزمایشی (Sandbox)** و **عملیاتی (Production)** تقسیم می‌شوند. حساب‌ آزمایشی دارای [سقف کاربر](https://chabokpush.com/pricing.html) می‌باشد و بیشتر از آن به شما سرویس داده نمی‌شود. بنابراین برای اپلیکیشن‌های اپ‌استور و تجاری توصیه می‌کنیم از حساب عملیاتی که سقف ندارد، استفاده کنید.
