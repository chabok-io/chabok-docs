...
اولین اقدامی که شما برای شروع چابک باید انجام دهید، [ایجاد یک حساب کاربری]() است. به طور کلی حساب‌های چابک به دو بخش آزمایشی (Sandbox) و عملیاتی (Production) تقسیم می‌شوند. در ابتدا شما با حساب آزمایشی آغاز می‌نمایید سپس در صورت نیاز از [پنل خود]() درخواست حساب عملیاتی را ثبت می‌نمایید. در صورتی هم که می‌خواهید از سرویس پوش‌نوتیفیکیشن چابک استفاده نمایید باید [کلیدهای گوگل را دریافت نمایید]().
