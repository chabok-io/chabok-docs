...
به طور کلی  کاربران شما با ۳ روش برای کاربرد‌های مختلف گرو‌بندی می شوند:
...
بخش سگمنت در واقع پیشرفته‌ترین ابزار چابک برای گروه‌بندی کاربران می‌باشد. با این ابزار شما می‌توانید کابرانتان را با ترکیب فیلترهای متعدد به گروه‌های بسیار ریز و دقیقی تقسیم کنید. این فیلترها تنوع گسترده‌ای را در اختیار شما می‌گذارد تا همواره دست بازتری برای ارتباط هدفمند با کاربرانتان داشته باشید. برخی از این‌ها عبارتند از **رفتار**، **موقعیت مکانی**، **بازدید**، **ویژگی‌های دستگاه** و ... کاربران. تنها راه ایجاد و ذخیره سگمنت از طریق **پنل** است. بدین صورت که شما پس از وارد شدن در پنل به بخش **ارسال پیام متنی** می‌روید و در بخش گیرندگان گزینه سگمنت را انتخاب می‌نمایید.
