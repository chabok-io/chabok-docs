...
#### نکات ضروری نصب کتابخانه   
 ...
 <ul>
 <li>به <a href="https://console.firebase.google.com/">پنل فایربیس</a> خود وارد شوید و پروژه خود را باز کنید.</li>
 ...
 >`نکته:` فایل ذکر شده را پس از دانلود، در پوشه ماژول اصلی برنامه در کنار فایل تنظیمات چابک قرار دهید.
