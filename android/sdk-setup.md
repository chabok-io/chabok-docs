...
- امضای دوم:
> i این قابلیت برای تعرفه‌های **رشد** و **اختصاصی** است. در صورت استفاده از آن‌، شما به این تعرفه‌ها انتقال داده می‌شوید. برای اطلاعات بیشتر در مورد تعرفه‌ها، لطفا به صفحه [قیمت‌ها](https://chabokpush.com/pricing.html) مراجعه فرمایید.
