...
پس از طی کردن مراحل صفحه [پیش‌نیازها](https://doc.chabokpush.com/android/required.html)، **راه‌اندازی SDK چابک** را شروع خواهیم کرد. در ابتدا اقدام به [نصب کتابخانه چابک](sdk-setup.html#۱--نصب-کتابخانه) کنید و سپس برای فعالسازی پوش‌نوتیفیکیشن چابک بخش‌ [افزودن `GcmReceiver` به فایل `Manifest`]() را مطالعه کرده و همانند مستندات بیان شده پیش بروید و در آخر، شروع به [مقداردهی و راه‌اندازی]() کتابخانه چابک در اپلیکیشنتان نمایید.
