...
### ۱- نصب کتابخانه 
کتابخانه چابک از طریق `jcenter` در دسترس است. برای این منظور ابتدا قطعه کد زیر را در فایل `gradle` اصلی پروژه اضافه کنید. 
...
کد زیر را در انتهای `gradle` ماژول اپلیکیشنتان اضافه کنید.
