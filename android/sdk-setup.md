...
#### نکات ضروری نصب کتابخانه   
 ...
 - `google-services.json` را از پنل firebase خود دانلود کنید و در پوشه ماژول اصلی اپلیکیشن قرار دهید. برای راهنمایی بیشتر به نکته زیر توجه کنید:
 ۱. مرحله اول: دانلود فایل
 - به حساب فایربیس خود وصل شوید و پروژه خود را باز کنید.
 - بر روی آیکون تنظیمات کلیک و گزینه Project settings را انتخاب نمایید.
 - برای پیکربندی نیاز به نام پکیج خود دارید.
 - بر روی  google-services.json کلیک کنید و در نهایت آن را به اپلیکیشن خود اضافه نمایید.
 ۲. مرحله دوم: قرار دادن فایل تنظیمات google-services.json در پوشه ماژول اصلی برنامه
 >`نکته:` محل قرارگیری فایل ذکر شده درست جایی است که فایل تنظیمات چابک قرار دارد.
 <br>
...
- در مرحله آخر نیاز است کد‌های زیر را فراخوانی کنید.
