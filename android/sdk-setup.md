...
- امضای دوم:
> i این قابلیت برای تعرفه‌های **رشد** و **اختصاصی** است. در صورت استفاده از آن‌ در حساب‌های عملیاتی، شما به این تعرفه‌ها انتقال داده می‌شوید. برای اطلاعات بیشتر در مورد این تعرفه‌ها، لطفا به صفحه [قیمت‌](https://chabokpush.com/pricing.html) مراجعه فرمایید.
