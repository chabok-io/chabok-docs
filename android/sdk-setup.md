...
>`نکته:` گر از نسخه‌های پایین‌تر از ۳ کتابخانه چابک استفاده می‌کنید توصیه می‌کنیم کتابخانه چابک را به نسخه ۳ <a href="android/release-note.html#%D8%A7%D8%B1%D8%AA%D9%82%D8%A7">**ارتقا**</a> دهید.
