...
پس از طی کردن مراحل صفحه [پیش‌نیاز‌ها](/android/required.html)، می‌توانید **راه‌اندازی SDK چابک** را شروع کنید.
 برای انجام این مراحل ابتدا نیاز است کتابخانه چابک را [نصب](https://doc.chabok.io/android/sdk-setup.html#%DB%B1--%D9%86%D8%B5%D8%A8-%DA%A9%D8%AA%D8%A7%D8%A8%D8%AE%D8%A7%D9%86%D9%87) کنید. سپس [مقداردهی و راه‌اندازی](/sdk-setup.html#۲-مقداردهی-اولیه-initialize) کتابخانه چابک را در اپلیکیشنتان انجام دهید و در آخر برای شناخت کاربر توسط چابک، مرحله [ثبت کاربر](/sdk-setup.html#۳-ثبت-کاربر) را حتما پشت سر بگذارید. 
