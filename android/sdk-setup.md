...
> `نکته:` چابک برای **ارسال پیام** هنگامی که کاربر به سرور چابک متصل است (باز بودن اپلیکیشن) **از سرویس آنی خود** استفاده می‌کند و در صورت عدم اتصال به چابک (بسته بودن اپلیکیشن) اقدام به **ارسال پوش‌نوتیفیکیشن** می‌کند تا کاربر را از داشتن پیام چابک مطلع سازد. این روند به صورت **خودکار** در چابک انجام می‌شود، همچنین چابک به صورت خودکار مدیریت اتصال را انجام می‌دهد و در شبکه‌هایی با سرعت بسیار پایین پیام شما را به دست کاربرانتان می‌رساند.
