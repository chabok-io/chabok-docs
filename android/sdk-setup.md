...
متد `login` تنها یک بار صدا زده می‌شود و آن هم زمانیست که آن هم زمانیست که کاربران برای اولین بار وارد اپلیکیشن شدن و یا در آن ثبت‌نام کردند، در غیر این صورت لزومی ندارد با هر بار ورود یا ثبت‌نام کاربر در اپلیکیشن، متد را نیز فراخوانی کنید.
