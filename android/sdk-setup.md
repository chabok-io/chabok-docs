...
به طور کلی چابک از **دو متد** برای ثبت کاربر استفاده می‌کند. **متد اول پس از عضویت و ایجاد حساب کاربری است (کاربر دائم)** که شما اطلاعاتی را از کاربرتان کسب کرده‌اید. این متد `register` نام دارد. **متد دوم قبل از عضویت است (کاربر مهمان)** که کاربر حسابی را ایجاد نمی‌کند و شما کاربر را به عنوان مهمان می‌شناسید. این متد `registerAsGuest` نام دارد.


#### ثبت کاربر مهمان (Register As Guest)
...
#### ثبت کاربر دائم (Register After User Sign up)
