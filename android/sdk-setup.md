...
#### نکات ضروری نصب کتابخانه   
 ...
 برای دانلود این فایل، مراحل زیر را طی کنید:
  ...
  - - به <a href="https://console.firebase.google.com/">پنل فایربیس</a> خود وارد شوید و پروژه خود را باز کنید.
  - -  بر روی آیکون تنظیمات کلیک کنید و گزینه  Project settings  را انتخاب نمایید.
  - - از لیست اپلیکیشن‌ها، اپلیکیشن مورد نظر خود را انتخاب کنید.
  - - بر روی google-services.json کلیک کنید و آن را دانلود کنید.
