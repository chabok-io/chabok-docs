...
در چابک همه نصب‌ها مورد قبول نیستند. بعضی از نصب‌ها به خاطر رفتار مشکوک و غیر طبیعی رد می‌شوند (نصب شمرده نمی‌شوند یا به ترکر ارگانیک نسبت داده می‌شوند و در واقع به هیچ ترکری نسبت داده نمی‌شوند). برای مطالعه بیشتر [اینجا](/react-native-bridge/tracker.html#مکانیزم-ضد-تقلب-fraud-prevention) را کلیک کنید.
...
چابک می‌تواند به شما کمک کند که نصب‌هایی که از طریق گوگل ادز یا UAC (Universal Ad Campaign) اجرا می‌کنید را بررسی کنید. برای مطالعه موارد تکمیلی به بخش [نحوه شمارش ترکر](/react-native-bridge/tracker.html#نحوه-شمارش-و-کارکرد-چابک) مراجعه کنید.
