...
در ابتدا اطمینان یابید که صفحه [معرفی](/react-native-bridge/introducing.html) را برای آشنایی کامل با امکانات چابک با دقت مطالعه کرده باشید. برای بکارگیری چابک، شما نیاز به [ایجاد حساب کاربری](/react-native-bridge/required.html#ایجاد-حساب-چابک)، [دریافت کلیدهای گوگل](/react-native-bridge/required.html#دریافت-کلیدهای-گوگل) برای اندروید و [ایجاد گواهی اپل](/react-native-bridge/required.html#ایجاد-گواهی-اپل) برای آی‌اواس دارید.
