...
رخدادی که شما تعیین می‌کنید به عنوان **رفتار کاربر** در **داشبورد** پنل با هدف تحلیل شما از آمار وقوع این رخدادها توسط هر کاربر ثبت خواهد شد. این قابلیت به شما اجازه می‌دهد تا **عملکرد اپلیکیشن** خود را براساس این رخدادها در بازه‌های زمانی مختلف بررسی کنید و با **پیام‌هایی** که ارسال می‌کنید آن را تا حدودی کنترل کنید.
