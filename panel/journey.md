...
حال اگر این عدد کمتر از عدد **گروه کنترل (یعنی کاربرانی که به طور ارگانیک خرید می‌کردند)** باشد،  یعنی **کمپین بهینه** نبوده یا اشتباهی در تعریف و اجرای سفر مشتری وجود داشته است.
