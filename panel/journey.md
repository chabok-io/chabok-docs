...
ARPU چیست؟ ARPU مخفف Averange Rate Per User  است که نشان دهندۀ متوسط درآمد به ازای هر کاربر است.

اگر درآمد خود را در یک بازه زمانی خاص به تعداد کل کاربران فعال در آن بازه زمانی تقسیم کنید، ARPU خود را رقم زده اید.

ARPU= درآمد در بازه زمانی خاص/ تعداد کل کاربران فعال در آن بازه  

#### اهمیت ARPU 

برای اینکه کسب و کار شما سر پا بماند باید عدد ARPU بزرگتر از CPU (Cost Per User) یا هزینه هر کاربر باشد یعنی میزان هزینه‌ای که شما برای داشتن یک کاربر می‌کنید کمتر از درآمد حاصل از آن کاربر باشد. ARPU یک معیار ساده و بسیار مفید برای بررسی میزان رشد یا کاهش درآمد شما در طول یک فصل یا کمپین‌های خاص است.

#### گروه کنترل چیست؟

شما کمپین‌ها و سفرهای مختلفی را برای بازگرداندن و حفظ کاربران‌تان اجرا می‌کنید. با این حال، اندازه گیری کارآیی این کمپین‌ها و سفرها به طور مستقل دشوار است. مثلا  افزایش خریدهای امروز به دلیل ایمیلی بوده که دیشب ارسال کردید یا ممکن است این کاربران بدون یادآوری خرید کرده باشند؟

گروه کنترل مجموعه کاربرانی است که با هیچ  فعالیت بازاریابی لمس نمی‌شوند. با مقایسه این گروه با گروه کاربرانی که کمپین‌های شما را دریافت کردند، می‌تونید اثربخشی اقدامات و ابتکارات خود را بسنجید.

قسمت بعدی آن آمار کلی تعامل‌های مربوط به سفر است که می‌توانید از 

بازخورد و آمار آن‌ها مطلع شوید.

![enter image description here](http://uupload.ir/files/vr4o_journey-report-2.png)