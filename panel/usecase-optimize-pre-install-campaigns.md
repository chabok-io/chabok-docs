...
بعد از این که شما شمارنده برای کمیپن نصب خود ایجاد کردید، می‌توانید نمود آن را در بخش تنظیمات قسمت **شمارنده‌ی نصب** مشاهده کنید. همچنین در جزئیات دستگاه هر کاربر، **نام** کمپین نصب اضافه شده است.
