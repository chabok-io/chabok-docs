...
**جذب کاربر موثر** یکی از مهم‌ترین قدم‌های شما برای **رشد** اپلیکیشنتان است. در عین حال، با وجود شبکه‌های مختلف تبلیغاتی، کانال‌ها و رسانه‌های متنوع، مدیریت این فرایند پیچیدگی‌های خود را دارد. چابک از **دو** جهت به شما در بهینه‌سازی کمپین‌های نصب‌تان کمک می‌کند. در مرحله اول **اندازه‌گیری کیفیت کمپین‌های نصب** از طریق شمارش‌ کلیک، نصب و رفتار‌های کاربران جذب شده. مرحله دوم اجرای مکانیزم‌های **بهبود تعامل موثر** و **افزایش نرخ بازگشت** کاربران برای **وفادار کردن** آنان است. 

<Br>

### مناسب‌ترین شبکه تبلیغاتی را شناسایی کنید

با چابک مناسب‌ترین شبکه تبلیغاتی را از طریق **سنجش عملکرد و رفتار کاربر** پس از نصب شناسایی کنید. ساده‌ترین معیار سنجش عملکرد هر کمپین، **تعداد کلیک، نصب و نرخ تبدیل** آن است. با در اختیار داشتن این داده‌ها می‌توانید **کیفیت کمپین‌های** خود را بسنجید و آن‌ها را با هم مقایسه کنید؛ با این کار **مناسب‌ترین شبکه تبلیغاتی** را شناسایی خواهید کرد و می‌توانید دفعات بعد، کمپین‌های **بهینه‌تری** را طراحی کنید. همچنین چابک **گزارشات کلی** از رابطه کمپین با رفتارهای کاربران به شما می‌دهد. مثلا چه تعدادی از کاربران **کمپین جشنواره بهار** محصولی را به سبد خرید خود اضافه کردند یا بازدید‌های بیش از یک بار در روز داشته‌اند.
...
ابتدایی‌ترین روش تحلیل عملکرد کمپین‌ها از طریق شمارش **کلیک‌هایی** است که آن کمپین پس از انتشار در کانال‌های تبلیغاتی به عمل می‌آورد (CPC). رایج‌ترین روش پس از آن شمارش **نصب‌هایی** است که از آن کمپین حاصل می‌شود (CPI). اکنون پیشرفته‌ترین روش برای **تحلیل عملکرد یک کمپین** شمارش **رفتار محور** است که کاربر جذب شده از آن کمپین در اپلیکیشن شما انجام می‌دهد (CPA). با چابک علاوه بر دو روش قبلی، شما می‌توانید این روش را با استفاده از قابلیت **سگمنت** تجربه کنید. در این حالت بر خلاف ادجاست می‌توانید حتی **رفتار‌های پیچیده کاربر** را به کمپین نصب وصل کنید. مثلا **فرکانس** یک رفتار کاربر در **محدوده زمانی خاصی** را می‌توانید با کمپین نصب آن تطبیق دهید یا حتی رفتار‌ها را با هم **ترکیب کنید**. 
