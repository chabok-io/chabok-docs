---
id: frequently-used-segments
title: سگمنت‌های متداول
layout: panel
permalink: panel/frequently-used-segments.html
---
...
#### سگمنت کاربرانی که مدتی رفتاری را انجام نداده‌اند
برای این کار کافیست آخرین باری که رفتار رخ داده است را انتخاب کنید و سپس مدت مد نظرتان را وارد کنید.
...
#### سگمنت کاربرانی که در یک بازه‌ زمانی در گذشته رفتاری را انجام داده‌اند
