...
اولین قسمت پنل چابک به **داشبورد** اختصاص دارد. این داشبورد در پنج قسمت اصلی **[ترافیک](/panel/dashboard.html#ترافیک)**، **[گروه‌ها](/panel/dashboard.html#گروهها)**، **[رفتار](/panel/dashboard.html#رفتار)**، **[تکنولوژی](/panel/dashboard.html#تکنولوژی)** و **[پراکندگی جغرافیایی](/panel/dashboard.html#پراکندگی-جغرافیایی)** (در صورت استفاده از خدمات مکانی) **آمار تحلیلی** کاربرانتان را برای کمک به درک رفتارشان در اختیار شما قرار می‌دهد. آمار این صفحه **لحظه‌ای** است و به صورت آنی به‌ روز‌ رسانی می‌شود. برای درک راحت‌تر روند جهشی آمار، معیار‌های مختلف آنالیتیکس در قالب **نمودار‌های** متنوع و کاربردی نشان داده شده‌اند.

<Br>

>`نکته:` برای نگهداری آمار داشبورد می‌توانید هر یک از نمودار‌ها را در فرمت‌های `PNG` ،`JPEG` ، `PDF` و `SVG` ذخیره کنید و یا مستقیما آن‌ها را چاپ نمایید. 
...
![عکس مربوطه](http://uupload.ir/files/2lv6_quick-stats.png)
<Br>
...
![enter image description here](http://uupload.ir/files/e7sd_dashboard-engagement.png)
...
![enter image description here](http://uupload.ir/files/pm7e_dashboard-messages.png)
...
![enter image description here](http://uupload.ir/files/85ms_dashboard-installs.png)
...
![عکس مربوطه](http://uupload.ir/files/pcf2_download-churn.png)
...
![عکس مربوطه](http://uupload.ir/files/shso_groups.png)
...
![enter image description here](http://uupload.ir/files/hj2x_custom-and-system-events.png)
...
![عکس مربوطه](http://uupload.ir/files/t37e_geo-distribution.png)
