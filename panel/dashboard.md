...
‍‍‍‍`Device not found`: این خطا به معنای پیدا نکردن کاربر توسط چابک است. دلیل آن می‌توانید اشتباه وارد کردن شناسه کاربری (`userId`) به هنگام ارسال پیام یا نصب نکردن نسخه جدید اپ شما که چابک را همراه خود دارد باشد.

`Subscrption not found`: این خطا به معنای عضو نبودن کاربر مخاطب در کانالی که پیام را ارسال کرده‌اید.
