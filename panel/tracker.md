...
کافه بازار به تازگی تبلیغات ویدئویی را پشتیابی می‌کند، یعنی کاربر در حین دیدن ویدئوی تبلیغاتی دعوت به نصب اپلیکیشن می‌شود و با کلیک بر روی دکمۀ دانلود، بدون خارج کردن کاربر از محیط پخش ویدئو، در پس زمینه دانلود و نصب صورت می‌گیرد. برای تعریف ترکری که از نوع تبلیغات ویدئوی کافه بازار است کافیست نام شبکه تبلیغاتی را **«Cafe bazar video»** قرار دهید.
