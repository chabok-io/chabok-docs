...
در این قسمت شما می‌توانید برای کمپین‌های نصب خود، **ترکر** تعریف کنید. برای این کار باید **نام** و **لینک مقصدی** که در کمپینتان قرار دادید را در اینجا ثبت کنید. این ترکر را می‌توانید براساس **پلتفرم** تعیین کنید تا برای هر پلتفرم لینک مقصد مخصوص به خود قرار گیرد.
