...
در **اختصاص لینک مقصد اندروید**، شما با انتخاب استور (کافه بازار، پلی استور یا مارکت دلخواه کاربر) **دیگر نیازی به وارد کردن لینک مخصوص آن استور را ندارید** و چابک خودش به طور هوشمند این کار را انجام می‌دهد. در صورت انتخاب کافه بازار یا پلی استور، کاربر مستقیما به هر کدام از آن‌ها هدایت می‌شود. در صورت انتخاب مارکت، از کاربر با توجه به استورهایی که روی دستگاه خود دارد پرسیده می‌شود که کدام باز شود.
...
![عکس مربوطه](http://uupload.ir/files/q63j_tracker-details-1.png)
![عکس مربوطه](http://uupload.ir/files/9eps_tracker-details-2.png)
