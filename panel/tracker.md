...
چابک به طور پیش‌فرض **۴ ترکر** را برای هر حساب قرار می‌دهد. این ترکرها **ارگانیک** (نصب‌هایی که  به طور طبیعی و بدون کمپین رخ داده‌اند)، **تبلیغات گوگل** (Google Ads)، **جستجوی گوگل پلی استور** و [**تبلیغات کافه بازار**](/panel/settings.html#تبلیغات-کافه-بازار) هستند. 
