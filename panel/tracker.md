...
<div style="text-align: center;"><img src="http://uupload.ir/files/vy6u_sub-tracker.jpg" class="img-fluid" style="
    width: 800px;
"></div>
...
>`نکته مهم:` دقت داشته باشید در هنگام ایجاد ترکر، سطح‌های انتخابی شما پرش نداشته باشد. برای مثال اگر **نام کمپین** داده‌اید، **شبکه تبلیغاتی** هم پر شده باشد زیرا در صورت خالی بودن آن آمار را نخواهید داشت. 
...
![عکس مربوطه](http://uupload.ir/files/lqtz_53ep_tracker-detail-1.png)
