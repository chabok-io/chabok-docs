...
### سطح‌بندی پویا (Dynamic Campaign Structure)

سطح‌بندی پویا به شما امکان می‌دهد تا با ساخت یک ترکر بی نهایت **زیر ترکر (subtracker)** داشته باشید. هدف زیر ترکرها در واقع دسته‌بندی مخاطبان، برای ارزیابی و در نتیجه بهینه‌سازی هرچه بیشتر است. به عنوان مثال شما می‌خواهید کمپین‌های تابستانه خود را برای گرفتن نصب بروید. طبیعی است که شما این کار را با یک کمپین و یا یک محتوا منتشر نکنید. در این حالت می‌توانید به سادگی به تعدادکمپین‌های خود زیر ترکر بسازید و عملکرد جمعی و فردی هر کدام را بررسی کنید. در ادامه باز هم می‌توانید برای هر زیر ترکر کمپین، زیر ترکر‌های ریزتر (برای محتوا) بسازید و به همین ترتیب ادامه دهید.
...
<th style="text-align: right">پارمترهای UTM گوگل</th>
...
شما می‌توانید نام کمپین، شبکه تبلیغاتی، گروه تبلیغاتی و خلاقانه مخصوص خود را به ترکر اضافه کنید. با این کار شما ترکرهای خود را **سطح‌بندی** می‌کنید تا آن‌ها را به صورت جداگانه بررسی کنید. این سطح‌بندی‌ها پیش‌فرض هستند و شما می‌توانید از طریق [افزودن پارامتر]() آن را پویا کنید.
