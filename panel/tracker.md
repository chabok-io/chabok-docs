...
بعد از ایجاد ترکرِ کافه بازار، مشتری باید **لینک ترکر** را در پنل کافه بازار خود قرار دهد، وقتی کاربر جدیدی ویدئو تبلیغاتی را می‌بیند به چابک اطلاع می‌دهد و یکی به عدد **تعداد نمایش** اضافه می‌شود. حال اگر در این بازۀ زمانی نصبی صورت بگیرد ترکر چابک آن را نصب از سوی ویدئوی کافه بازار در نظر می‌گیرد.
