...
شما می‌توانید علاوه بر **نام** و **لینک مقصد** به ترکر خود فیلترهای دیگری هم اضافه کنید. 
...
در ادامه شما می‌توانید به ترکر خود **شبکه و گروه تبلیغاتی**، **پارامتر**، **لینک کال‌بک** و **محدوده اتریبیوشن** اضافه کنید:
