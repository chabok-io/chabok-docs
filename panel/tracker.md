...
در این صفحه علاوه بر تعیین رویداد (یا اکشن) می‌توانید **هدف** نیز مشخص کنید. 
 سربرگ هدف علاوه بر مشخص کردن نام هدف، به شما این امکان را می‌دهد تا برای رسیدن به یک یا چند رویداد، سگمنت‌هایی همراه با چندین ویژگی (attribute) تعریف کنید.
...
برای درک بهتر این موضوع، مثالی را بازگو خواهیم کرد. 

فرض کنید صاحب کسب و کار آنلاینی هستید و قصد دارید بسنجید چه تعداد از کاربران بعد از کلیک ترکر و نصب اپلیکیشن، بر روی ثبت‌نام در اپلیکیشن کلیک می‌کنند در نتیجه این ایونت زمانی رخ می‌دهد که کاربر تمام فیلد‌های موجود را پر کند و بر روی کلید ثب‌نام کلیک کند.   
اما حالا قصد داریم ببینیم چه تعداد کاربر بعد از نصب اپلیکیشن از طریق هر چنلی (کافه بازار، لینک موجود در استوری اینستاگرام و ...) اپلیکیشن را نصب می‌کند را بسنجیم در نتیجه سگمنت خاصی بر اساس یک یا چند ویژگی (موقعیت مکانی: کرج و نوع دستگاه اندروید) ایجاد می‌کنیم و بعد از آن می‌بینیم چه تعداد کاربر بر اساس این ویژگی‌های خاص در اپلیکیشن ثبت‌نام کرده در نتیجه باید بر روی افزودن هدف کلیک کنیم.  
