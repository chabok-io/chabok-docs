...
گزینه هدف در ترکر به آژانس‌های تبلیغاتی این امکان را می‌دهد تا همزمان چندین ویژگی را با هم انتخاب کنند و نتایج را بر اساس آن وضعیت مشاهده کنند 

به مثال زیر توجه کنید:

فرض کنید آژانس تبلیغاتی یک رویداد خرید را اضافه کرده و قصد دارد کمپینی با توجه به چندین شرط (تعداد بازدید، سن، وضعیت کاربر) همزمان به تعدادی از کاربران ارسال کند در نتیجه شرط‌ها را تعیین می‌کند و در انتها نتایج را مشاهده خواهد کرد.
