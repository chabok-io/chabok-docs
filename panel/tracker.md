...
در این قسمت شما می‌توانید برای کمپین‌های نصب خود، **ترکر** [تعریف کنید](/panel/tracker.html#ایجاد-ترکر-جدید). برای این کار باید **نام** و **لینک مقصدی** که در کمپینتان قرار دادید را در اینجا ثبت کنید. این ترکر را می‌توانید براساس **پلتفرم** تعیین کنید تا برای هر پلتفرم لینک مقصد مخصوص به خود قرار گیرد. پس از فعال کردن ترکر می‌توانید آمار لحظه‌ای آن را [مشاهده کنید](/panel/tracker.html#آمار-ترکر ).

<Br>

### ایجاد ترکر جدید

![عکس مربوطه](http://uupload.ir/files/tjj_newtracker.png)

>` نکته:` ترکرها به طور معمول نصب را **اولین بازدید** حساب می‌کنند (مانند سرویس ادجاست)، اما مزیت ترکر چابک در شمارش نصب این است که شما می‌توانید علاوه بر مدل ادجاست (اولین بازدید و در نظر گرفتن کاربر به عنوان کاربر مهمان) نصب را **پس از ورود کاربر و احراز هویت او** در اپلیکیشنتان تعریف کنید. با این کار شما یک اقدام دیگری برای جلوگیری از تقلب در شمارش نصب انجام می‌دهید به این دلیل که امضاهای کاربر قبل و بعد از ثبت او (register) مطابقت داده می‌شوند و در صورت تایید به عنوان یک نصب سالم در نظر گرفته می‌شوند. 

<Br>

علاوه بر این شما می‌توانید به ترکر خود **پارامتر**، **لینک کال‌بک** و **محدوده اتریبیوشن** اضافه کنید:
