...
### کاربران تستی
 ...
 این ویژگی به شما این امکان را می‌دهد تا برخی از کاربران خود را به عنوان کاربران تستی انتخاب کنید و به کمک پوش نوتیفیکیشن یا صندوق پیام، [پیام تستی](/panel/inbox.html#ارسال-تستی) را به کاربران تستی ارسال کنید.
