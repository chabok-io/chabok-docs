...
>`نکته`: در قسمت بالای تب کاربران، گزینه جستجو وجود دارد که به کمک آن می‌توانید کاربران خود را بر اساس شروط **شناسه کاربر**، **تاریخ نصب**، **آخرین بازدید**، **دفعات بازدید**، **وضعیت توکن**، **تگ**، **نام ترکر**، **شناسه دستگاه**، **شناسه تبلیغاتی**، **پلتفرم‌ها** و ... جستجو کنید و آن‌ها را پیدا کنید. 
