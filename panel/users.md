...
- **عمومی**: شامل تگ، دسترسی نوتیفیکیشن و موقعیت مکانی
...
- **اطلاعات**: این اطلاعات را شما خودتان [تعیین می‌کنید](/android/features.html#ثبت-اطلاعات-کاربر-user-attributes) و سفارشی هستند. مانند: نام، نام خانوادگی، سن، جنسیت، دفعات انجام رفتاری. 

- **رفتار**: این رفتارهای را شما خودتان [تعیین می‌کنید](/android/behavior-tracking.html#متد-رصد) مانند: کامنت، خرید، سفارش، افزودن به سبد یا علاقه‌مندها و ... .
