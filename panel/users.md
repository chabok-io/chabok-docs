...
چابک این امکان را می‌دهد تا برخی از کاربران را به عنوان کاربران تستی انتخاب کنند و به کمک پوش نوتیفیکیشن یا صندوق پیام، [پیام تستی](/panel/inbox.html#ارسال-تستی) را به کاربران ارسال کنند.
