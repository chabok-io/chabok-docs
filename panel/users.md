...
این گزینه زمانی کاربرد دارد که کاربران قصد داشته باشند با UserId جدیدشان برای بار دوم در سایت (آدرس ترکر) رفتاری از خود نشان دهند. با کلیک بر روی این گزینه تمامی اطلاعات مربوط به شناسه کاربر پاک می‌شود و کاربر مجدد در سایت باید ثبت‌نام کند و رفتاری از خود نشان ‌دهد.
![عکس مربوطه](http://uupload.ir/files/cx4x_attribution.png)
 
به مثال زیر توجه کنید:

فرض کنید کاربری در سایتی ثبت‌نام کرده و خریدی انجام داده است، بعد از گذشت مدت زمان محدودی، کاربر تصمیم می‌گیرد مجددا با شناسه جدید وارد سایت شود و رفتار جدیدی از خود نشان دهد. در صورت نبود این گزینه، این حالت امکان‌پذیر نیست اما الان کاربر می‌تواند این گزینه را فعال کند و بعد از آن مجدد با شناسه جدید وارد سایت شود.
