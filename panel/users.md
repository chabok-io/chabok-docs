...
کاربر از لینک ترکر A نصبی را انجام داده و اطلاعات او بر روی ترکر ذخیره شده است، حالا تصمیم دارد با لینک جدید B در اپلیکشن نصبی را انجام دهد (برای تست). پس صاحبان اپلیکیشن باید بر روی گزینه **فراموشی اتریبیوشن**  کلیک کند و یک بار اپلیکشن را حذف کند در نتیجه کاربران برای تست می‌توانند از طریق لینک جدید مجدد اپلیکشن را نصب کنند و  نصب جدید نیز با ترکر شمارش می‌شود. 
