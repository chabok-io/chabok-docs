...
کاربر از لینک ترکر A نصبی را انجام داده و حالا تصمیم دارد برای تست با لینک جدید B در اپلیکشن نصبی را انجام دهد. در این زمان صاحبان اپلیکیشن بر روی گزینه **فراموشی اتریبیوشن**  کلیک می‌کنند و یک بار اپلیکشن را حذف می‌کنند در نتیجه کاربران برای تست می‌توانند از طریق لینک جدید مجدد اپلیکشن را نصب کنند و با ترکر این نصب‌ها را بشمارند. 
