...
به طور کلی چابک شامل دو محیط می‌باشد: **محیط آزمایشی (sandbox)** و **محیط عملیاتی (production)**. بنابراین برای انتقال به محیط عملیاتی باید درخواست خود را در همین قسمت ثبت کنید تا چابک پس از تایید درخواست، اطلاعات جدید حسابتان را برای شما تعیین کند.
