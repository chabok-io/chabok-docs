...
>   نکته:  برای دریافت **سرشماره و کلید ارتباطی** باید یک ایمیل به واحد فروش آتیه داده پرداز ارسال کنید و بخواهید این اطلاعات را در اختیارتان قرار دهد. 
