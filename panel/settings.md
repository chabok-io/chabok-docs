...
![عکس مربوطه](http://uupload.ir/files/mxs8_settings.png)
...
در این قسمت می‌توانید نصب‌هایی که از **تبلیغات در جستجوی کافه‌بازار (Search Ads)** می‌گیرید را **رصد** کنید. برای این کار باید ابتدا در پنل چابک آن‌ را **فعال** کنید:
