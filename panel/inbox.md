...
با ورود به جزئیات هر یک از کمپین‌های ارسال شده خود می‌توانید آن‌ها را مشاهده و ارزیابی کنید. این جزئیات شامل جزئیات کمپین (مانند محتوا، نوع ارسال، زمان ایجاد و ...)، آمار ارسال (تعداد و روند تحویل پیام و نوتیفیکیشن‌ها) و **آمار بازخورد** (بازخورد نوتیفیکیشن، رویداد‌های تاثیر پذیرفته و درآمد از هر کدام) است.
