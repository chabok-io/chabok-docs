...
فرض کنید قصد دارید کمپینی با تخفیف ویژه ۵۰٪ را به تمام کاربران اپلیکیشن‌تان ارسال کنید، قبل از اجرای کمپین، باید یک‌‌بار پیام را به به کاربران تستی ارسال کنید تا از درستی آن اطمینان حاصل کنید و سپس کمپین را به تمام کاربران اپلیکیشن‌تان با اطمینان کامل ارسال کنید.

>`نکته`: ارسال تستی پیام به کاربران تنها در یکی از دو روش **صندوق پیام** یا **پوش‌نوتیفیکیشن** امکان‌پذیر است. 
