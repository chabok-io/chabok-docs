...
۳-  پیام **در انتظار** ارسال است. به طور کلی پیام چابک به محض باز شدن اپلیکیشن تحویل داده می‌شود؛ بنابراین زمانی که پیام ارسال می‌کنید درصف (حداکثر تا ۳۰ روز) قرار می‌گیرد تا کاربر وارد اپلیکیشن شود.
