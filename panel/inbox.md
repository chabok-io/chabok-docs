...
پس از ارسال پیام‌ها به کاربران مورد نظر، می‌توانید با توجه به **ذخیره شدن** آن‌ها در پنل، از جزئیات کامل آن‌ها برای بررسی استفاده کنید. در این صفحه، پیام‌ها با سه دسته [**کمپین**](/panel/inbox.html#کمپینها)، [**کمپین‌های خودکار**](/panel/inbox.html#کمپینهای-خودکار) و [**پیام‌**](/panel/inbox.html#پیامها) نمایش داده شده‌اند.
...
![عکس مربوطه](http://uupload.ir/files/xy8z_cehi_campaign-list.png)
...
![عکس مربوطه](http://uupload.ir/files/09t1_uirk_campaign-analytics.png)
...
![عکس مربوطه](http://uupload.ir/files/11l2_m93d_autocampaignlist.png)
...
![عکس مربوطه](http://uupload.ir/files/yi1_z1nl_inbox-list.png)
