...
پس از ارسال پیام‌ها به کاربران مورد نظر، می‌توانید با توجه به **ذخیره شدن** آن‌ها در پنل، از جزئیات کامل آن‌ها برای بررسی استفاده کنید. در این صفحه، پیام‌ها با دو دسته [**کمپین**](/panel/inbox.html#کمپینها) و [**پیام‌**](/panel/inbox.html#پیامها) نمایش داده شده‌اند.
...
- ‍‍`Device not found`: **عدم وجود دستگاه مورد نظر** (از صحت شناسه کاربری (`userId`) مخاطب پیام اطمینان یابید.)
...
- `BadDeviceToken`:  **استفاده از Simulator آی‌اواس** ( به طور کلی پوش‌ روی Simulator آی‌او‌اس دریافت نمی‌شود.)
