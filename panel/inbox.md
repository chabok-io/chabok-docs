...
پس از آن، لیست کمپین‌های شما به ترتیب ارسال و با جزئیات **سیاست ارسال** (صندوق پیام چابک یا پوش‌نوتیفیکیشن)، **زمان دقیق** درخواست ارسال، **کانال‌های** گیرنده، **وضعیت تحویل** پیام (نوار سبز تحویل و زرد به معنای در انتظار تحویل است) و **متن** پیام قابل مشاهده است.
...
در این قسمت می‌توانید کمپین طراحی کنید و برای کاربرانتان ارسال کنید. نحوه طراحی کمپین به طور کامل در صفحه [ارسال](/panel/send.html) توضیح داده شده است.
...
پس از فعال کردن پوش‌ خودکار مکانی، می‌توانید اولا آن را **ویرایش** کنید و دوما آمار پوش‌هایی که ارسال شده است را مشاهده کنید.
