...
**رفتاری** که شما با چابک رصد می‌کنید با سه حالت **اولین، آخرین و تعداد** در انتخاب فیلترهای سگمنت اضافه می‌شوند. به عنوان مثال رفتار **خرید** را در نظر بگیرید. شما می‌توانید به کاربرانی که برای **اولین بار** خریدی را انجام داده‌اند، پوش ارسال کنید؛ یا به کاربرانی که چند وقت است خرید انجام نداده‌اند (با انتخاب **آخرین خرید**)، پوش بفرستید و یا به کاربرانی که **تعداد خاصی** خرید کرده‌اند، ارسال کنید.
