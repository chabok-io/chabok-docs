...
اگر بخواهید از فیلتر **date** در متن پیام پنل خود استفاده کنید باید نمونه زیر را بنویسید.
...
اگر **date** به فرمت تاریخ شمسی باشد، باید فرم زیر را به متن پیام خود در پنل اضافه کنید.
...
اگر قصد دارید در متن پیام کاربر، عدد نمایش دهید، باید از فیلتر `locale` استفاده کنید و به شکل زیر، آن را بنویسید.

مثلا کاربری یک آیتمی را خرید کرده و در ازای تکمیل خرید باید مبلغ ۲۰۰,۰۰۰ ریال را پرداخت کند. در این حالت متن پیام در پنل به شکل زیر خواهد بود: 

```
{{abc | locale("fa-IR")}}
```
و در نتیجه کاربر ۲۰۰,۰۰۰ را در انتها مشاهده خواهد کرد.
