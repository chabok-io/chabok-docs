...
###### **پوش خودکار در صورت رخ ندادن رویداد**
از تاخیر می‌توانید برای **خودکارسازی ارسال پوش برای کاربرانی که مدتی است رویدادی را انجام  نداده‌اند** هم استفاده کنید. به این ترتیب که شما یک رویدادی را (مثلا خرید) را انتخاب می‌کنید و می‌خواهید در صورت گذشتن ۷ روز از نخریدن کاربران به آن‌ها به طور خودکار پوش بزنید. برای فعال‌سازی کافی‌ است رویداد فعال کننده را خرید بگذارید و با تاخیر ۷ روز رویداد متوقف کننده را هم خرید قرار دهید. 
