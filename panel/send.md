...
![عکس مربوطه](http://uupload.ir/files/7ogx_upload-image.png)
...
![عکس مربوطه](http://uupload.ir/files/er72_notification-action.png)
...
![عکس مربوطه](http://uupload.ir/files/9q3l_platform-settings.png)
...
در لینک مقصد می توانید از دیپ لینک هم برای اندروید و آی‌اواس استفاده کنید.
