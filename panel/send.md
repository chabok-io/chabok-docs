...
##### هوشمند
ارسال هوشمند، پیام‌های شما را **به هر کاربر در زمانی که بیش‌ترین بازدید** را داشته است می‌فرستد. این بهترین روشی است تا نرخ تبدیل پیام‌هایتان را افزایش دهید.

به عنوان مثال کاربری به طور معمول **هر روز حدود ساعت ۱۰ صبح** از وبسایت یا اپلیکیشن شما استفاده می‌کند. چابک زمان این بازدیدها را رصد و ذخیره می‌کند و از آن در **سه ماه** گذشته برای تعیین پر بازدید ترین ساعت کاربر استفاده می‌کند.
