...
حصول اطمینان از اینکه مراحل انجام کار به درستی صورت گرفته بسیار مهم است، پس بهتر است قبل از ارسال نهایی کمپین به کاربران اپلیکیشن یا سایت  به صورت تستی مواردی چون متن پیام، نحوۀ نمایش درست آن و جایگیری صحیح دکمه‌ها و تصاویر را بررسی کنیم.
...
بعد از کلیک روی این آیکون تگ  CHABOL_TEST به پایین پروفایل کاربر اضافه می‌شود

##### نحوۀ سگمنت کردن کابران تستی؟

بعد از مشخص کردن کاربران تستی نوبت به سگمنت کردن آنهاست. برای این کار به بخش سگمنت در پنل رفته و روی سگمنت جدید کلیلک کنید. عنوانی مانند کاربران تستی تعریف کنید و از لیست tag را انتخاب کرده و از بخش یکی از CHABOK_TEST را انتخاب کنید 

و سپس نام کاربر را وارد کرده و ارسال تستی را بزنید، می‌توانید در دستگاه تستی پیام پوش ارسال شده را بررسی کنید.

##### چطور لیست کاربران تستی را در پنل چابک ببینیم؟

با مراجعه به بخش پروفایل، کاربران و قسمت جستجو عبارت CHABOK_TEST را تایپ کنید، اینطور لیست کاربران تستی در دسترس شماست.