...
>`نکته:` دقت داشته باشید در مثال بالا، ارتباط  رفتار و اطلاعات کاربر (user) را برقرار کنید. یعنی مثلا مقداری (value)  که به رفتار داده‌اید را در اطلاعات کاربر بگذارید و نام آیتم را به آن مقدار اختصاص دهید.
