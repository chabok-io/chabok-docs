...
>` نکته:` در رابطه با حجم تصویر باید بگوییم که طبیعتا هر چه پایین‌تر باشد، کاربرانی با شبکه‌های کند و ضعیف قادر خواهند بود سریعا بهش دسترسی پیدا کنند. برای همین توصیه می‌کنیم تصاویر را در فرمت‌های فشرده (مانند jpeg) و با حجم زیر ۵۰۰ کیلوبایت آپلود کنید.
