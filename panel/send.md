...
![عکس مربوطه](http://uupload.ir/files/45jx_private.png)
...
![عکس مربوطه](http://uupload.ir/files/1abs_filter.png)
...
![عکس مربوطه](http://uupload.ir/files/vgkl_segm.png)


در قسمت سگمنت از قابلیت **کمپین خودکار** چابک هم می‌توانید استفاده کنید. این قابلیت به شما اجازه می‌دهد تا کمپین‌های شما براساس رخداد‌هایی که خودتان تعیین و ذخیره می‌کنید به صورت خودکار با اتفاق آن رخداد برای کاربر ارسال شود.

![عکس مربوطه](http://uupload.ir/files/k1kr_triggered.png)
