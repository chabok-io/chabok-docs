...
یکی از گزینه‌های زمان ارسال، گزینه **خودکار** است که به شما امکان می‌دهد تا با تعیین یک رویداد، پوش خود را کار بگذارید. برای استفاده از پوش خودکار کافی است نام **رویداد فعال کننده** پوش را وارد کنید، سپس زمانبندی آن را مشخص نمایید. زمانبندی را می‌توانید براساس روزهای هفته تعیین کنید که پوش شما فقط در آن زمان‌ها فعال باشد. پس از آن محدودیت تعداد ارسال پوش را در زمان مشخص باید معین کنید.

همینطور می‌توانید برای پوش خودکار خود **تاخیر** (Delay) بگذارید. این تاخیر می‌تواند همراه با یک رویداد لغو کننده باشد. مثلا شما برای رویداد افزودن به سبد خرید پوش خودکار گذاشتید و می‌خواهید در صورت وقوع ندادن رویداد **خرید** تا یک زمان خاصی پوش ارسال شود. 
...
![عکس مربوطه](http://uupload.ir/files/gukz_autopush.png)
