...
>- `نکته:`در نسخه آی‌او‌اس ۱۲، عکس اعلان‌ها با یکی از دو نسبت ۱:۱ یا ۳:۲ نمایش داده می‌شوند. درصورتی که نسبت طول به عرض عکس با اندازه‌های گفته شده تطابق نداشته باشد، عکس بصورت خودکار توسط سیستم‌ عامل بریده می‌شود.
   عدم رعایت این مورد باعث می‌شود عکس به صورت کامل نمایش داده نشود.


>`نکته:`حداقل نسخه گیرنده پیام در نسخه آی‌اواس و اندروید باید به صورت زیر باشد:
>- محدودیت نسخه آی‌او‌اس: تمام دستگاههای تلفن همراه باید آی‌اواس ۱۰ داشته باشند.
>- محدودیت نسخه اندروید: تمام دستگاههای تلفن همراه باید اندروید ۴ یا بالاتر را با api سطح ۱۶ دداشته باشند.
