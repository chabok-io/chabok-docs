...
پیام‌رسانی چابک از **۳** طریق انجام می‌شود.  روش اول ارسال **پوش‌نوتیفیکیشن** است که با توجه به پلتفرم، از سرویس‌های مخصوص به خود استفاده می‌شود (مثلا برای اندروید از GCM/FCM).  روش دوم پیام‌رسانی مخصوص به چابک است که از کانال‌های ارتباطی خود استفاده می‌کند. این نوع پیام‌رسانی را استفاده از **صندوق پیام چابک** می‌گوییم. روش سوم، ارسال از طریق پیامک (SMS) است. شما می‌توانید با توجه به نیاز خود هر کدام از این روش‌ها را برای ارسال کمپین‌هایتان انتخاب کنید.

##### تفاوت صندوق پیام با پوش‌نوتیفیکیشن

 صندوق پیام به طور مستقل از طریق سوکت و کانال‌ها پیام ارسال می‌کند. 
در صورتی که گزینه **صندوق پیام چابک** را انتخاب کنید، چابک به طور **هوشمند** از هر دو روش (صندوق پیام چابک و پوش‌نوتیفیکیشن) برای ارسال کمپین استفاده می‌کند. به این ترتیب که اگر اپلیکیشن روی دستگاه کاربر **باز** باشد، **پیام چابک** ارسال می‌شود و اگر اپلیکیشن **بسته** باشد، یک **نوتیفیکیشن** برای آوردن کاربر به اپلیکیشن استفاده می‌شود. 
