...
- **سگمنت**: سگمنت یا **گروه‌بندی پیشرفته** به شما این امکان را می‌دهد تا مخاطبان پیامتان را با ترکیب فیلتر‌های متعدد چابک گروه‌بندی کنید و هر کدام را با نام دلخواهتان ذخیره کنید. این سگمنت‌ها براساس معیارهای **بازدید** (اولین، آخرین و تعداد)، **دسترسی کاربر** (نسخه برنامه، سیستم‌عامل و نوع دستگاه)، **تگ** و **موقعیت مکانی** و همچنین **رصد رفتار‌های کاربر** (آن‌هایی که نام **رخداد** دارند) ایجاد شده‌اند.
...
![عکس مربوطه](http://uupload.ir/files/1ve_receiving-policy.png)
...
![عکس مربوطه](http://uupload.ir/files/mo8n_sms.png)
