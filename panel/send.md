...
**آی‌اواس**: از اینجا با وارد کردن نام دسته (Notification Category) نوتیفیکیشن، می‌توانید دکمه‌ها را مانند نوتیفیکیشن‌های ذخیره شده این دسته قرار دهید.
...
از این طریق می‌توانید نوتیفیکیشن‌های خود را گروه‌بندی کنید تا در صورت دریافت بیش از یک عدد نوتیفیکیشن به جای زیر هم نمایش داده شدن به طور جداگانه، جمع شوند (collapse).
