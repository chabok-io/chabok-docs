...
در صورتی که قصد نمایش عدد را به کاربران دارید از فیلتر `locale` استفاده کنید و باید به فرم زیر، آن را بنویسید.
...
اگر بخواهید آرایه‌ای از رشته را با نمادی مثل **,** از هم جدا کنید باید از فیلتر **join** استفاده کنید. 

```
{{abc | join(', '))}}
```
در آخر چیزی که به کاربر نمایش می‌دهد به شکل زیر خواهد بود:
