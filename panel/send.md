...
**عنوان**: نام مشخص برای هر دکمه را عنوان دکمه می‌نامیم که مشخص کردن آن اجباری است.

**دیپ لینک یا لینک سایت**: با مشخص کردن این قسمت، کاربران بعد از کلیک بر روی دکمه، به صفحه مربوطه هدایت می‌شوند.

برای کسب اطلاعات بیشتر در رابطه با دیپ لینک‌ها بر روی [لینک](https://doc.chabok.io/react-native-bridge/deeplink.html) کلیک کنید.
...
اگر قصد دارید دکمه نوتیفیکیشن خود را حذف کنید کافیست بر روی آیکون حذف کلیک کنید.
