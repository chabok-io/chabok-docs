...
چابک به شما این امکان را می‌دهد تا کاربران را بر اساس سگمنت دسته‌بندی کنید و کمپین‌هایی را بر اساس فیلترهای بازدید، موقعیت مکانی، فناوری، رفتار و اطلاعات کاربران ارسال کنید تا تعامل کاربران بهبود یابد.
...
در این بخش می‌توانید کاربران خود را به صورت پیشرفته گروه‌بندی کنید. این کار را می‌توانید با گذاشتن فیلترهای متنوع و متعدد انجام دهید.
 ...
 >`نکته`: فیلتر‌های سگمنت به شما امکان می‌دهد تا کاربران خود را بر اساس **همه‌ی شرط‌ها** و یا **يکی از شروط** گروه‌بندی کنید. به عنوان مثال تصمیم دارید کاربران خود را بر اساس **نوع دستگاه: اندروید و نسخه سیستم عامل: ۵.۱.۱** فیلتر کنید پس باید گزینه **همه** را انتخاب کنید، اما اگر تصمیم داستید کاربران را بر اساس **نوع دستگاه: اندروید یا نسخه سیستم عامل: ۵.۱.۱** فیلتر کنید باید از گزینه **یکی از** استفاده کنید.
