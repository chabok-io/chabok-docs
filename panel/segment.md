...
![عکس مربوطه](http://uupload.ir/files/ggau_segment-timelines.png)
  ...
  برای مشاهده برخی از حالات متداول سگمنت به [این صفحه](/panel/frequently-used-segments.html) مراجعه کنید.
...
#### کاربرانی که در یک بازه‌ زمانی در گذشته رفتاری را انجام داده‌اند
