...
![عکس مربوطه](http://uupload.ir/files/3atx_general.png)

- **تگ**: از تگ برای برچسب گذاری کاربران به طور دلخواه استفاده می‌شود. (مثلا مرد یا حساب طلایی)
- **دسته کاربر**: برای دسته‌بندی تصادفی کاربران می‌توان از این فیلتر استفاده کرد. به فرض مثال چابک کاربران شما را به صورت تصادفی به هزار دسته تقسیم می‌کند که اگر بخواهید از تست A/B برای دسته‌بندی کاربران استفاده کنید باید دسته کاربر (کوچک‌تر یا مساوی ۱۰۰) برای کاربران خود انتخاب کنید.
- **کاربر تستی**: چابک به کاربرانی که در پنل عضو هستند این امکان را می‌دهد تا تعدادی از کاربران خودشان را به عنوان کاربران تستی انتخاب کنند. (به فرض مثال اپلیکیشنی ۵۰ دستگاه از کاربران خود را در پنل به عنوان کاربر تستی مشخص کرده است.)

<Br>  

##### محلیت 

![عکس مربوطه](http://uupload.ir/files/82gj_geo-targeting.png)
...
**ارزش کاربر**: فرض کنید کاربری که خرید در اپلیکیشن را انجام داده است ارزشی برابر با ۲ را دارد در نتیجه ارزش خریدی که توسط هر کاربر در اپلیکیشن انجام می‌شود، ۲ است که تعریف ایوند متناسب با هر بیزینسی دارای ارزش مالی یا امتیاز متفاوتی است.
...
- **وضعیت توکن**: کاربران را می‌توان با توجه به وضعیت توکن فیلتر کرد.
- **دسترسی کانال پوش**: از این فیلتر برای دسته‌بندی کاربران با توجه به امکان دسترسی ارسال پوش به کاربران استفاده می‌شود. (به عنوان مثال: آن دسته از کاربرانی که اجازه دریافت پوش از دستگاه خود را ندارند.)
- **دسترسی کانال پیامک**: این فیلتر برای دسته‌بندی کاربران بر اساس دسترسی به ارسال شدن یا نشدن پیامک به کاربران استفاده می‌شود. 
- **دسترسی کانال ایمیل**:  کاربران را با توجه به اینکه امکان دسترسی برای ارسال ایمیل وجود دارد یا خیر دسته‌بندی می‌شوند. کاربرانی که به هر دلیل امکان دسترسی به ارسال ایمیل به آن‌ها را ندارید را می‌توانید از این قسمت فیلتر کنید.
...
-**وضعیت کاربر**: وضعیت کاربر به شما این امکان را می‌دهد تا متوجه شوید کاربر در چه وضعیتی قرار دارد؟ (مهمان، لاگین، حذف و یا حذف نکردن اپلیکیشن)

- **زمان لاگین**: کاربران در چه برهه زمانی وارد اپلیکیشن شدند و یا در آن ثبت‌نام کردند را می‌توان به کمک  فیلتر زمان مشخص‌ کرد.
- **زمان حذف**: از این فیلتر می‌توانید زمانی استفاده کنید که کاربران اپلیکیشن را حذف کردند.
- **طول عمر**: به مدت زمانی که کاربر اپلیکیشن را نصب کرده طول عمر می‌گویند که می‌توانید آن را فیلتر کنید. (بر اساس برابر، نابرابر، کوچک‌تر، وجود داشته باشد و ...)
...
>`نکته`: چابک به شما این امکان را می‌دهد تا ویژگی و اطلاعات کاربران خودتان را بر اساس نوع داده‌های مختلف (data, int, string,...) و یا آرایه‌ای از رشته‌ها ارسال کنید. 
...
یکی دیگر از ویژگی‌های جدید و مهم چابک، **پنجره زمانی ثابت** است. به این معناست که با گذشت زمان، سگمنت شما ثابت است و تیغیر نمی‌کند. برای مثال شما در روز یکشنبه سگمنت تاریخ تولد را برای کسانی که تاریخ تولدشان اول فروردین سال ۷۰ هست ایجاد کردید، در این صورت مقدار سگمنت ثابت است و تنها کسانی را شامل می‌شود که اول فرودین سال ۷۰ به دنیا آمدند و نه تمامی کاربران را.  
