...
- اگر تمام شروط با هم برقرار باشد.(همه کاربرانی که یک بار وارد اپلیکیشن شدند **و** نوع دستگاهشان اندروید یا آی‌او‌اس بوده.) باید از گزینه **همه** برای فیلتر استفاده کنید.

- در صورتی که یکی از شروط برای دسته‌بندی کاربران صدق کند.(همه کاربرانی که یک بار وارد اپلیکیشن شدند **یا** نوع دستگاه‌شان اندروید یا آی‌او‌اس است.) از گزینه **یکی از* استفاده کنید. 
