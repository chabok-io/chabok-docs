...
- **دسترسی کانال ایمیل**:  کاربران را با توجه به اینکه امکان دسترسی برای ارسال ایمیل وجود دارد یا خیر، دسته‌بندی می‌شوند. کاربرانی که به هر دلیل امکان دسترسی ارسال ایمیل به آن‌ها را ندارید را می‌توانید از این قسمت فیلتر کنید.
