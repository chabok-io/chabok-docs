...
**ارزش کاربر**: فرض کنید به ازای هر خرید در اپلیکیشن یک امتیاز به کاربر اختصاص داده می‌شود. پس می‌توان نتیجه گرفت که تعریف ایوند متناسب با هر بیزنیسی دارای ارزش مالی یا امتیازی متفاوتی است.
