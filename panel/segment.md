...
>`نکته:`توجه داشته باشید که در فیلتر‌های سگمنت منظور از همه، برقراری همه شرایط با هم است. (به عنوان مثال در فیلتر فناوری باید هر دو شرط برقرار باشد هم نوع دستگاه اندروید و هم نسخه سیستم عامل ۵.۱.۱ باشد.) در صورتی که یکی از شروط برقرار نباشد آن فیلتر شمارش نمی‌شود.  

>`نکته:` در فیلترهای سگمنت اگر شرط را بر روی یکی از قرار دهید. کاربرانی شمارش می‌شوند که یکی از شرایط را دارا باشند. (یعنی یا نوع دستگاه اندروید و یا نسخه سیستم عامل ۵.۱.۱ هست.)
