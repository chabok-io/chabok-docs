...
<Br>
 ...
 <Br>  
  ...
  >`نکته`: فیلتر‌های سگمنت به شما امکان می‌دهد تا کاربران خود را بر اساس **همه‌** و یا **يکی از**  شرط‌ها گروه‌بندی کنید. به عنوان مثال تصمیم دارید کاربران خود را بر اساس **نوع دستگاه: اندروید و نسخه سیستم عامل: ۵.۱.۱** فیلتر کنید پس باید گزینه **همه** را انتخاب کنید، اما اگر تصمیم داشتید کاربران را بر اساس **نوع دستگاه: اندروید یا نسخه سیستم عامل: ۵.۱.۱** فیلتر کنید باید از گزینه **یکی از** استفاده کنید.
  یا

سگمنت در چابک به شما این امکان را می‌دهد تا به کمک شروط **یکی از** یا **همه** کاربران خود را فیلتر کنید. اگر تمام شروط برقرار باشد (همه کاربرانی که بیش از یک بار وارد اپلیکیشن شدند **و** نوع دستگاهشان اندروید یا آی‌او‌اس بوده) باید از گزینه **همه** استفاده شود و در صورتی که بخواهیم یکی از شرط‌ها برای گروه‌بندی کاربران صدق کند.(همه کاربرانی که بیش از یک بار وارد اپلیکیشن شدند **یا** نوع دستگاه‌شان اندروید یا آی‌او‌اس باشد.) باید از گزینه **یکی از** استفاده کنید. 

برای تفهمیم بهتر به عکس‌های زیر توجه کنید:

 ![عکس مربوطه](http://uupload.ir/files/7bhm_2019-12-15_17-12-13.png)

 مثال:
 
 ![عکس مربوطه](http://uupload.ir/files/owhu_segment.png)
