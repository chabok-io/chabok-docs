...
یا Pre-install Tracker یک روش اتریبیوشن است که در ابتدا برای رصد نصب اپلیکیشن‌هایی بود که در مرحله تولید در دستگاه گذاشته می‌شوند (Built-in)، اما الان در موارد دیگر هم از همین روش استفاده می‌شود.
