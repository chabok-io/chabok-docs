...
<ul>
<li>ابتدا وارد پنل شوید و به صفحه ساخت ترکر جدید در تب ترکر بروید.</Li>

<li><a href="https://doc.chabok.io/panel/tracker.html#%D8%A7%D8%B7%D9%84%D8%A7%D8%B9%D8%A7%D8%AA">اطلاعات کاربر</a>خود را وارد کنید و در صورت دلخواه، سطح‌بندی ترکر که مربوط به کمپین هست را نیز تکمیل کنید .</li>
...
<li>لینک مقصد خود را همراه با اطلاعات  وارد کنید.</li>
...
<li>در صورت استفاده از کال‌بک نیاز به تکمیل تنظیمات پیشرفته دارند.</li>

<li>در غیر این صورت بر روی "ایجاد" کلیک کنید.</li>

<li>بعد از ایجاد، لینک ترکر را کپی کنید و در اختیار برنامه‌ نویسان قرار دهید.</li>
