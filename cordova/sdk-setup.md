...
```
>`نکته:` دقت داشته باشید که [اندروید](/cordova/sdk-setup.html#۱--نصب-کتابخانه-اندروید) و [آی‌اواس](/cordova/sdk-setup.html#۱--نصب-کتابخانه-آی‌او‌اس) نیاز به نصب جداگانه دارند که در ادامه به هر دو پرداخته می‌شود:
...
مقداردهی اولیه در اندروید به صورت زیر انجام می‌شود.
...
مقداردهی اولیه در نسخه آی‌او‌اس به صورت زیر انجام می‌شود.
...
در نسخه انروید برای ثبت کاربر نیاز است به صورت زیر عمل کنید.
...
در نسخه آی‌او‌اس برای ثبت کاربر به صورت زیر عمل کنید.
