...
در ابتدا اطمینان یابید که صفحه [معرفی](/unity/introducing.html) را برای آشنایی کامل با امکانات چابک با دقت مطالعه کرده باشید. برای بکارگیری چابک، شما نیاز به [ایجاد حساب کاربری](/unity/required.html#ایجاد-حساب-چابک) دارید.
