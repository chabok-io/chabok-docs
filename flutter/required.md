...
در ابتدا اطمینان یابید که صفحه [معرفی](/flutter/introducing.html) را برای آشنایی کامل با امکانات چابک با دقت مطالعه کرده باشید. برای بکارگیری چابک، شما نیاز به   [ دریافت کلیدهای گوگل](/flutter/required.html#دریافت-کلیدهای-گوگل) دارید.
