...
در ابتدا اطمینان یابید که صفحه [معرفی](/flutter/introducing.html) را برای آشنایی کامل با امکانات چابک با دقت مطالعه کرده باشید. برای بکارگیری چابک، شما نیاز به [ایجاد حساب کاربری](/flutter/required.html#ایجاد-حساب-چابک) و [ دریافت کلیدهای گوگل](/flutter/required.html#دریافت-کلیدهای-گوگل) دارید.
...
> `نکته:` در حال حاضر از فریم‌ورک **Flutter** فقط در **اندروید** پشتیبانی می‌شود.
