...
در متدهای ثبت کاربر یا ثبت کاربر مهمان، شما می‌توانید پارامتر **AdId** را هم به آن‌ها اضافه کنید. اضافه کردن این پارامتر به شما امکان می‌دهد نصب‌هایی که تبلیغات آن از این کلید استفاده می‌کنند (مانند تبلیغات بنر و جستجوی کافه بازار، گوگل اد وردز) را شمارش کنید.
