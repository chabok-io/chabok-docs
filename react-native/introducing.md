...
پلتفرم چابک در حوزه‌های [اتریبیوشن](/react-native/introducing.html#سرویس-اتریبیوشن-attribution)، [زیرساخت آنی](/react-native/introducing.html#سرویس-بکند-آنی-realtime-backend-service)، [تعاملات درون‌برنامه‌ای](/react-native/introducing.html#ارتباط-مستقل-از-کانال-omni-channel-communication)، [اتوماسیون بازاریابی موبایل](/react-native/introducing.html#اتوماسیون-بازاریابی-موبایل-mobile-marketing-automation) و [آنالیتیکس](/react-native/introducing.html#آنالیتیکس-موبایل-و-وب-mobile--web-analytics) می‌تواند برای شما مفید باشد.
