...
کتابخانه `react-native-device-info` به طور پیش‌فرض برای Referrer را دریافت می‌کند. بنابراین می‌توانید استورهایی که از Referrer پشتیبانی می‌کنند را از این طریق ترک کنید.   
