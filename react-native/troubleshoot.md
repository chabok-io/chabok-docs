...
در این صفحه به عیب‌یابی مشکلات متداول توسعه‌دهندگان در پیاده‌سازی چابک و ارائه راه‌‌حل‌های مربوط به آن می‌پردازیم. برخی از این مشکلات عبارتند از عدم [دریافت پوش‌نوتیفیکیشن](/react-native/troubleshoot.html#پوش-نمیگیرم) و [نمایش اعلان](/react-native/troubleshoot.html#اعلانها-نمایش-داده-نمیشوند).
