...
<span style="background-color: #a4c639; height: 30px; color: #fff; display: inline-block; padding: 1px 10px 1px 10px; font-weight: bold; font-size:12px; border-radius: 5px;">Android</span>
