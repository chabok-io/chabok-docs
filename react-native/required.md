...
در ابتدا اطمینان یابید که صفحه [معرفی](/react-native/introducing.html) را برای آشنایی کامل با امکانات چابک با دقت مطالعه کرده باشید. برای بکارگیری چابک، شما نیاز به [ایجاد حساب کاربری](/react-native/required.html#ایجاد-حساب-چابک) و همچنین [دریافت کلیدهای گوگل](/react-native/required.html#دریافت-کلیدهای-گوگل) برای اندروید و  [ایجاد گواهی اپل](/react-native/required.html#ایجاد-گواهی-اپل) برای آی‌اواس دارید.
